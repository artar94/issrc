...
; *** Misc. errors
ErrorCreatingDir=Програмі інсталяції не вдалося створити папку "%1"
ErrorTooManyFilesInDir=Програмі інсталяції не вдалося створити файл у папці "%1", оскільки вона містить занадто багато файлів
...
NoUninstallWarning=Інсталяційною програмою виявлено, що на вашому комп'ютері вже встановлено такі компоненти:%n%n%1%n%nСкасування вибору цих компонентів не призведе до їх видалить.%n%nПродовжити?
ComponentSize1=%1 КБ
ComponentSize2=%1 МБ
...
PreviousInstallNotCompleted=Не завершено інсталяцію чи видалення попередньої програми. Вам слід перезавантажити комп'ютер, щоб завершити поточну інсталяцію.%n%nПісля перезавантаження комп'ютера запустіть програму інсталяції ще раз, щоб завершити інсталяцію [name].
...
FinishedLabel=Інсталяцію [name] на ваш комп'ютер завершено. Застосунок може бути запущено шляхом вибору встановлених створених ярликів.
...
SetupAborted=Інсталяцію не завершено.%n%nБудь ласка, усуньте неполадку і запустіть програму інсталяції ще раз.
...
ErrorRestartingComputer=Програмі встановлення не вдалося перезавантажити комп'ютер. Зробіть це вручну.
